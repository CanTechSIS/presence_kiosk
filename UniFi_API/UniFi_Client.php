...
include_once __DIR__ . '/Exceptions/CurlExtensionNotLoadedException.php';
include_once __DIR__ . '/Exceptions/CurlGeneralErrorException.php';
include_once __DIR__ . '/Exceptions/CurlTimeoutException.php';
include_once __DIR__ . '/Exceptions/EmailInvalidException.php';
include_once __DIR__ . '/Exceptions/InvalidBaseUrlException.php';
include_once __DIR__ . '/Exceptions/InvalidCurlMethodException.php';
include_once __DIR__ . '/Exceptions/InvalidSiteNameException.php';
include_once __DIR__ . '/Exceptions/JsonDecodeException.php';
include_once __DIR__ . '/Exceptions/LoginFailedException.php';
include_once __DIR__ . '/Exceptions/LoginRequiredException.php';
include_once __DIR__ . '/Exceptions/MethodDeprecatedException.php';
...
class UniFi_Client
{
     ...
     * @throws CurlExtensionNotLoadedException
     */
